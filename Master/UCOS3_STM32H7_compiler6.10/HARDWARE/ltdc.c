...
#else
    //让编译器自动分配内存地址,故注释以下内容
	//u16 ltdc_lcd_framebuf[1280][800] __attribute__((at(LCD_FRAME_BUF_ADDR)));	//定义最大屏分辨率时,LCD所需的帧缓存数组大小
    //u16 ltdc_lcd_framebuf[1280][800] __attribute__((section(".ARM.__at_"str_LCD_FRAME_BUF_ADDR)));	//定义最大屏分辨率时,LCD所需的帧缓存数组大小
    u16 ltdc_lcd_framebuf[1280][800];
#endif

u32 *ltdc_framebuf[2];					//LTDC LCD帧缓存数组指针,必须指向对应大小的内存区域
_ltdc_dev lcdltdc;						//管理LCD LTDC的重要参数
/******************************************************************************
@Function: void LTDC_Switch(u8 sw)
...
@Modified: 2019-03-09 21:54 by Wang Zilin
******************************************************************************/
...
/******************************************************************************
@Function: void LTDC_Layer_Switch(u8 layerx,u8 sw)
...
@Modified: 2019-03-09 21:56 by Wang Zilin
******************************************************************************/
...
/******************************************************************************
@Function: void LTDC_Select_Layer(u8 layerx)
...
/******************************************************************************
@Function: void LTDC_Display_Dir(u8 dir)

@Description:设置LCD显示方向

@Created: by 正点原子@ALIENTEK

@Modified: 2019-03-09 21:57 by Wang Zilin
******************************************************************************/
...
/******************************************************************************
@Function: void LTDC_Draw_Point(u16 x,u16 y,u32 color)
...
/******************************************************************************
@Function: u32 LTDC_Read_Point(u16 x,u16 y)
...
@Modified: 2019-03-09 21:58 by Wang Zilin
******************************************************************************/
...
/******************************************************************************
@Function: void LTDC_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u32 color)
...
//}
/******************************************************************************
@Function: void LTDC_Color_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 *color)
...
@Modified: 2019-03-09 21:59 by Wang Zilin
******************************************************************************/
...
/******************************************************************************
@Function: void LTDC_Clear(u32 color)
...
@Modified: 2019-03-09 22:00 by Wang Zilin
******************************************************************************/
...
/******************************************************************************
@Function: u8 LTDC_Clk_Set(u32 pll3m,u32 pll3n,u32 pll3r)
...
/******************************************************************************
@Function: void LTDC_Layer_Window_Config(u8 layerx,u16 sx,u16 sy,u16 width,u16 height)
...
/******************************************************************************
@Function: void LTDC_Layer_Parameter_Config(u8 layerx,u32 bufaddr,u8 pixformat,u8 alpha,u8 alpha0,u8 bfac1,u8 bfac2,u32 bkcolor)
...
@Modified: 2019-03-09 22:01 by Wang Zilin
******************************************************************************/
...
/******************************************************************************
@Function: u16 LTDC_PanelID_Read(void)

@Description:读取面板参数,新增了判断悬空全一的排查
...
/******************************************************************************
@Function: void LTDC_Init(void)

@Description:
//LCD初始化函数
@Created: by 正点原子@ALIENTEK

@Modified: 2019-03-09 22:02 by Wang Zilin
******************************************************************************/
void LTDC_Init(void)
{   
	u16 lcdid=0;
...
/******************************************************************************
@Function: void HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)

@Description://LTDC底层IO初始化和时钟使能
