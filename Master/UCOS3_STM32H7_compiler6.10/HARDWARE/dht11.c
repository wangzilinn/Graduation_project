...
@Modified: 2019-03-01 11:36 by Wang Zilin
******************************************************************************/
void DHT11_Rst(void)	   
{                 
	DHT11_IO_OUT(); 	//设置为输出
...
@Modified: 2019-03-01 11:39 by Wang Zilin
******************************************************************************/
u8 DHT11_Check(void) 	   
{   
	u8 retry=0;
...
@Modified: 2019-03-01 11:40 by Wang Zilin
******************************************************************************/
...
@Modified: 2019-03-01 11:41 by Wang Zilin
******************************************************************************/
...
/******************************************************************************
@Function: u8 DHT11_Read_Data(float *temp,float *humi)    
...
@Modified: 2019-03-01 11:43 by Wang Zilin
******************************************************************************/   	 
u8 DHT11_Init(void)
{
